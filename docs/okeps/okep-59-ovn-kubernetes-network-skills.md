...
> Companion to [OKEP-5494: Model Context Protocol for Troubleshooting OVN-Kubernetes](./okep-5494-ovn-kubernetes-mcp-server.md).
...
1. Author the initial set of `SKILL.md` files under canonical `skills/`
   ...
   `skills/SKILLS.md` as the index + format reference.
