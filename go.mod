...
require (
	...
	github.com/ovn-kubernetes/ovn-kubernetes/go-controller v0.0.0-20260505052050-5c8b26380354
	k8s.io/api v0.36.2
...
require (
	...
	github.com/openshift/api v0.0.0-20260626010240-bb02c828dc55 // indirect
