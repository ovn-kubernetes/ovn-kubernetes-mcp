...
- Get a pod name as JSONPath: {"version": "v1", "kind": "Pod", "name": "my-pod", "namespace": "default", "output_type": "jsonpath", "json_path_template": "{.metadata.name}"}
...
- List pod names as JSONPath: {"version": "v1", "kind": "Pod", "namespace": "default", "output_type": "jsonpath", "json_path_template": "{.items[*].metadata.name}"}`,
		}, s.ListResources)
}
