...
// RunPodExecCommand runs a command on a pod container by name and namespace.
func (s *MCPServer) RunPodExecCommand(ctx context.Context, namespace, name, container string, command []string) (string, string, error) {
